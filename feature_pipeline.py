...
def create_enhanced_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Fill missing values for pollutant and weather columns
    cols_to_fill = [
    ...
    # Final fill in case lag features create NaNs
    df = df.ffill().bfill()
...
def main():
    ...
    # Save enhanced dataset with name matching FastAPI expectations
